...
async function generateCodeSigningAsync(projectRoot, { output, validityDurationYears: validityDurationYearsNumber, commonName }) {
    (0, assert_1.default)(typeof output === 'string', '--output must be a string');
    (0, assert_1.default)(typeof validityDurationYearsNumber === 'number', '--validity-duration-years must be a number');
